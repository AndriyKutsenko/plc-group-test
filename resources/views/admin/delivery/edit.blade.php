...
@section('content')
    <br>
    <h3>Delivery Cost Edit Action</h3>
    <form action="{{ route('delivery-save', ['id' => $item->id]) }}" method="post">
        @csrf
        ...
        Cost ($): <input type="text" name="cost" placeholder="0,00" value="{{ $item->cost }}"><br>
        <br>
        <br>
